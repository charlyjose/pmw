...
export function PlacementApplication() {
  ...
  const [new_application, setNewApplication] = useState(true);
  ...
  const [application_status, setApplicationStatus] = useState("SUBMITTED");
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      axios
        .get(`${API_URI}/api/student/placement/application`, config)
        .then((e) => {
          const applications = e.data.data.applications;

          if (applications.length > 0) {
            setNewApplication(false);

            // Spread the data into the form values
            ...
            // For Updates section
            setApplicationStatus(formValues.status);
            setApplicationDate(new Date(formValues.createdAt).toDateString());
            setLastUpdated(new Date(formValues.updatedAt).toDateString());
            setReviewComments(formValues.comments);

            // Set the form default values to the values from the database
            form.reset(formValues);

            // Typecast the values to the correct type
            form.setValue("roleStartDate", new Date(formValues.roleStartDate));
            form.setValue("roleEndDate", new Date(formValues.roleEndDate));
            form.setValue("workingHours", String(formValues.workingHours));
            form.setValue("salary", String(formValues.salary));

            // Set the location search values
            setOrganisationLocationGoogleMapsAddress(
              application.organisationLocationGoogleMapsAddress
            );
            setOrganisationLocationGoogleMapsLat(
              application.organisationLocationGoogleMapsLat
            );
            setOrganisationLocationGoogleMapsLng(
              application.organisationLocationGoogleMapsLng
            );
  ...
  return (
    <>
      {!new_application && (
        <>
          <div className="pb-10">
            ...
            <div className="grid grid-cols-6 gap-4 pt-10 pb-5">
              ...
              <div className="col-span-4">
                <Steps
                  ...
                  items={[
                    {
                      title: "Submitted",
                      description: `Submitted on ${application_date}`,
                    },
                    {
                      title: "Pending",
                      description:
            ...
            {review_comments != "" && (
              <>
                <div className="grid grid-cols-6 gap-4 pt-5 pb-10">
                  <div className="col-span-1"></div>
                  <div className="col-span-4">
                    <Alert className="border-lime-500 bg-lime-50 transition-all hover:bg-lime-100 hover:text-accent-foreground">
                      <LiaCommentsSolid className="h-4 w-4" />
                      <AlertTitle>Review comments</AlertTitle>
                      <AlertDescription>{review_comments}</AlertDescription>
                    </Alert>
                  </div>
                  <div className="col-span-1"></div>
                </div>
      ...
      <div>
        <div className="text-left text-lg font-bold pb-5">
          <span className="px-1 bg-lime-300 mr-2"></span>
          Application Form
          <Separator className="my-1" />
        </div>
              ...
              <div className="flex flex-col space-y-3">
                <div className="grid grid-cols-1 gap-4">
                  <span className="text-sm font-normal">
                    ...
                    student to notify the University of Leicester about a
                    placement offer. By submitting this form, you request
                    authorisation to have the role form part of your degree
                    programme. We will use this form to assess the placement
                  ...
                  <span className="text-sm font-normal">
                    ...
                    <p>
                      By submitting this form, you confirm that you will meet
                      the following requirements for your placement:
                    </p>
                    <ol className="text-xs p-2">
                      <li>
                        a. Act professionally and responsibly, both in your
                        studies and on placement, as well as, if required,
                        during your meeting probation periods. You must conduct
                        yourselves accordingly with due regard to the University
                        Senate Regulations, the Placement Provider, and the laws
                        and conventions of the country in which you are
                        undertaking your placement.
                      </li>

                      <li>
                        b. Adhere to attendance requirements and working hours
                        stipulated by the University and on your visa. This
                        involves not working more than the hours stated, either
                        inside or outside of the University.
                      </li>
                      <li>
                        c. If your placement is overseas, or involves
                        international travel, you must register for insurance
                        under the Group Personal Accident and Travel Policy
                        arranged by the University. To register, please complete
                        the{" "}
                        <a
                      ...
                      <li>
                        d. Inform the University if you have any queries or
                        concerns about your placement or Placement Provider.
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        Provider if you require special adjustments to be made
                        in order to undertake the placement
                      </li>
                      <li>
                      ...
                      <li>
                        i. Complete any tasks and assessment throughout the
                        duration of the placement within the deadlines
                        specified.
                      </li>
                    </ol>
                  </span>
                  ...
                  <span className="text-sm font-normal">
                    ...
                    <p>
                      ...
                      Placement Provider to provide further information, and
                      assess your placement. The majority of placements are
                      approved. However, common reasons that a placement might
                      be rejected include:{" "}
                    </p>
                    <ol className="text-xs p-2">
                      <li>
                        1. The Placement is unpaid and does not offer a high
                        quality work experience.
                      </li>
                      <li>
                        2. The Placement involves a high level of risk. As part
                        of this, we take into account whether an employer has
                        insurance to cover you for accidents.
                      </li>
                      <li>
                      ...
                      <li>
                        4. The Placement does not guarantee a high quality
                        learning experience. When we consider this, we will look
                        at the role description, the placement provider, and how
                        much remote working is planned on placement.
                      </li>
                    </ol>
                  </span>
                </div>
                              ...
                              <FormLabel>
                                ...
                                <p className="grid grid-cols-1 pt-2 pb-2 text-xs font-normal italic">
                                  <ol className="text-xs">
                                    <li>
                                      i. Indicate the proposed start date or
                                      month of your placement
                                    </li>
                                    <li>
                                      ii. This information can be updated nearer
                                      the time when you have an exact date
                                    </li>
                                  </ol>
                                </p>
                              </FormLabel>
                              ...
                              <FormDescription>
                                <p className="grid grid-cols-1 pt-2 pb-2 text-xs font-bold italic">
                                  ...
                                  <ol className="text-xs font-normal">
                                    <li>
                                      1. Your start date MUST be at least 10
                                      working days AFTER the date you submit
                                      this form to allow the university time to
                                      process your placement authorisation
                                      request
                                    </li>
                                    <li>
                            ...
                            <FormItem>
                              <FormLabel>
                                <span className="grid grid-cols-1 gap-4">
                                  ...
                                  description to your email submitting this
                                  form.{" "}
                                </span>
                                <p className="grid grid-cols-1 pt-2 pb-2 text-xs font-normal italic">
                                  If you do not have this, please contact the
                                  Placement Provider to receive a Role
                                  Description before submitting this form.{" "}
                                </p>
                              </FormLabel>
                              <FormControl>
                                <Textarea
                            ...
                            render={({ field }) => (
                              <FormItem>
                                <FormLabel>
                                  ...
                                  <p className="grid grid-cols-1 pt-2 pb-2 text-xs font-normal italic">
                                    Please confirm length of your probation
                                    period below{" "}
                                  </p>
                                </FormLabel>
                                <FormControl>
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  <FormLabel>
                                    ...
                                    work remotely. This should include how often
                                    you will work remotely each week.
                                  </FormLabel>
                                  <FormControl>
                                    <Textarea
                                      placeholder="Please provide further information"
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel>
                                ...
                                <p className="grid grid-cols-1 pt-2 pb-2 text-xs font-normal italic">
                                  If you do not know this, please put what you
                                  are planning to do.{" "}
                                </p>
                              </FormLabel>
                              <FormControl>
                              ...
                              <FormControl>
                                ...
                                >
                                  ...
                                  <FormItem className="flex items-center space-x-3 space-y-0">
                                    ...
                                    <FormLabel className="font-normal">
                                      No, this role does not involve working at
                                      a location different other than location
                                      given in section 2
                                    </FormLabel>
                                  </FormItem>
                                </RadioGroup>
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel>
                                ...
                                <p className="grid grid-cols-1 pt-2 pb-2 text-xs font-normal italic">
                                  For example, this might include civil
                                  disorder, crime, environmental disasters,
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel>
                                <span className="grid grid-cols-1 gap-4">
                                  What are your accommodation arrangements when
                                  on placement?{" "}
                                </span>
                                <p className="grid grid-cols-1 pt-2 pb-2 text-xs font-normal italic">
                                  If you do not know this, please put what you
                            ...
                            <FormItem>
                              <FormLabel>
                                <span className="grid grid-cols-1 gap-4">
                                  ...
                                  you are required to undertake before, during,
                                  or after the placement?
                                </span>
                                <p className="grid grid-cols-1 pt-2 pb-2 text-xs font-normal italic">
                            ...
                            <FormItem>
                              <FormLabel>
                                ...
                                <p className="grid grid-cols-1 pt-2 pb-2 text-xs font-normal italic">
                                  ...
                                  will not be shared with the Placement
                                  Provider. We will support you to consider your
                                  options.{" "}
                                </p>
                              </FormLabel>
                            ...
                            <FormItem>
                              <FormLabel>
                                ...
                                <p className="grid grid-cols-1 pt-2 pb-2 text-xs font-normal italic">
                                  ...
                                  This information will remain confidential and
                                  will not be shared with the Placement
                                  Provider. We will work with you to consider
                                  your options.{" "}
                                </p>
                              </FormLabel>
                              <FormControl>
                              ...
                              <FormControl>
                                ...
                                >
                                  ...
                                  <FormItem className="flex items-center space-x-3 space-y-0">
                                    ...
                                    <FormLabel className="font-normal">
                                      No, my placement is not overseas and does
                                      not require international travel
                                    </FormLabel>
                                  </FormItem>
                                </RadioGroup>
                              </FormControl>
                    ...
                    <div className="flex flex-col space-y-3">
                      <div className="grid grid-cols-1 gap-4">
                        <span className="text-sm font-normal italic">
                          ...
                          Leicester while you are on a placement. By completing
                          this form you accept the conditions and requirements
                          listed in the Responsibilities of Students on page one
                          of this document. You also confirm all the information
                          provided in this form is factually correct at the time
                          of submitting.
                        </span>
                      </div>
                    </div>
              ...
              <div className="flex flex-col space-y-3 pt-10">
                <div className="grid grid-cols-1 gap-4">
                  <span className="text-sm font-normal">
                    ...
                    within the University. Note that authorisation request can
                    take between 10-15 working days once this form has been
                    received by the University. Please allow at least 10 working
                    days before checking on the progress of your Placement
