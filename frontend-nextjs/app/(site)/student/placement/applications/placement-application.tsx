...
export function PlacementApplication() {
  ...
  const [current_status, setCurrentStatus] = useState("process");
  const [step_items, setStepItems] = useState([]);
      ...
      axios
        ...
        .then((e) => {
          ...
          if (applications.length > 0) {
            ...
            const last_updated = new Date(formValues.updatedAt).toDateString();
            ...
            // Show either the approved or rejected step
            if (formValues.status == "REJECTED") {
              step_items.splice(-2, 1);
            } else {
              step_items.pop();
            }
            setStepItems(step_items);
      ...
      <div>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            {/* <ScrollArea className="rounded-md h-[650px]"> */}
            <div className="flex flex-col space-y-3">
              <div className="grid grid-cols-1 gap-4">
                <span className="text-sm font-normal">
                  ...
                  programme. We will use this form to assess the placement role
                ...
                <span className="text-sm font-normal">
                  ...
                  <ol className="text-xs p-2">
                    <li>
                      ...
                      studies and on placement, as well as, if required, during
                      your meeting probation periods. You must conduct
                    ...
                    <li>
                      ...
                      duration of the placement within the deadlines specified.
                    </li>
                  </ol>
                </span>
                ...
                <span className="text-sm font-normal">
                  ...
                  <p>
                    ...
                    approved. However, common reasons that a placement might be
                    rejected include:{" "}
                  </p>
                  <ol className="text-xs p-2">
                    <li>
                    ...
                    <li>
                      ...
                      this, we take into account whether an employer has
                              ...
                              <p className="grid grid-cols-1 pt-2 pb-2 text-xs font-bold italic">
                                ...
                                <ol className="text-xs font-normal">
                                  <li>
                                    ...
                                    working days AFTER the date you submit this
                                    form to allow the university time to process
                                    your placement authorisation request
                                  </li>
                                  <li>
                              ...
                              >
                                <FormItem className="flex items-center space-x-3 space-y-0">
                                  ...
                                  <FormLabel className="font-normal">
                                    ...
                                    location different location other than given
                                    in section 2
                                  </FormLabel>
                                </FormItem>
                                <FormItem className="flex items-center space-x-3 space-y-0">
                          ...
                          <FormItem>
                            <FormLabel>
                              ...
                              <p className="grid grid-cols-1 pt-2 pb-2 text-xs font-normal italic">
                                ...
                                crime, environmental disasters, infectious
                                disease or poor healthcare access.{" "}
                              </p>
                            </FormLabel>
                            <FormControl>
                              <RadioGroup
                          ...
                          <FormItem>
                            <FormLabel>
                              <span className="grid grid-cols-1 gap-4">
                                ...
                                are required to undertake before, during, or
                                after the placement?
                              </span>
                              <p className="grid grid-cols-1 pt-2 pb-2 text-xs font-normal italic">
                          ...
                          <FormItem>
                            <FormLabel>
                              ...
                              <p className="grid grid-cols-1 pt-2 pb-2 text-xs font-normal italic">
                                ...
                                will not be shared with the Placement Provider.
                                We will support you to consider your options.{" "}
                              </p>
                            </FormLabel>
                          ...
                          <FormItem>
                            <FormLabel>
                              ...
                              <p className="grid grid-cols-1 pt-2 pb-2 text-xs font-normal italic">
                                ...
                                This information will remain confidential and
                                will not be shared with the Placement Provider.
                                We will work with you to consider your options.{" "}
                              </p>
                            </FormLabel>
                            <FormControl>
                              <RadioGroup
